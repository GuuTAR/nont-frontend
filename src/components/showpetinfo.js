const Showpetinfo = (props) => {
    return (
        <div style={{backgroundColor:"white", borderRadius: "20px", borderColor: "white",
                ...
                <p style={{marginLeft: "20px", marginTop: "10px", color: "#707070"}}>Have medical certificate : {(props.nontinfoList.length===0?"":props.nontinfoList[0].had_medical_cert.toString())}</p>
        </div>
    )
}
